...
class ScrollHelper {
  ...
  //   const { contentLength, offset, visibleLength } = this.getScrollMetrics();
  //   const distanceFromEnd = contentLength - visibleLength! - offset;
  //   const threshold = this._onEndReachedThreshold * visibleLength!;
  //   if (distanceFromEnd < threshold) {
  //     this.triggerScrollEventHelpers('onEndReached', {
  //       distanceFromEnd,
  //       contentLength,
  //       visibleLength,
  //       offset,
  ...
  _onScroll(e: NativeSyntheticEvent<NativeScrollEvent>) {
    ...
    this.resolveScrollMetrics();
    // console.log('onEndReached onscroll ', { ...e.nativeEvent })
